...
function buildFloat() {
  ...
  el.innerHTML = `
    <a href="https://wa.me/2348000000000?text=Hi%20FAFX%2C%20I%20want%20to%20learn%20trading" target="_blank" class="float-btn float-wa">
    ...
    <a href="https://t.me/FAFX_Trading" target="_blank" class="float-btn float-tg">
...
(function() {
  ...
  document.addEventListener('contextmenu', function(e) {
    e.preventDefault();
    showToast('© FAFX Trading Academy — Content is protected.');
    return false;
  });
  ...
  document.addEventListener('copy', function(e) {
    e.preventDefault();
    e.clipboardData.setData('text/plain', '© FAFX Trading Academy — All rights reserved. Visit: fafx-site.netlify.app');
    showToast('© FAFX — Copying is protected on this site.');
    return false;
  });

  // Detect DevTools open (width/height threshold method)
  ...
  setInterval(function() {
    ...
    if (widthDiff || heightDiff) {
      if (!devtoolsOpen) {
        devtoolsOpen = true;
        showToast('⚠️ Developer tools detected. This site is protected.');
      }
    } else {
      devtoolsOpen = false;
    }
  ...
  window.onbeforeprint = function() {
    showToast('© FAFX Trading Academy — Printing is not permitted.');
  };
